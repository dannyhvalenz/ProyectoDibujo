...
public class ContenedorPrincipal extends Stage {
    ...
    private void configurarFerb() {
        ...
        SiluetaFerb.setStroke(Color.rgb(251,193,137));
        ...
        CubicCurveTo cabelloFerb34 = new CubicCurveTo();
        cabelloFerb34.setX(181);
        cabelloFerb34.setY(168);
        cabelloFerb34.setControlX1(179);
        cabelloFerb34.setControlY1(146);
        cabelloFerb34.setControlX2(167);
        cabelloFerb34.setControlY2(118);
